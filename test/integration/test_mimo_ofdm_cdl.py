...
from sionna.phy.ofdm import OFDMModulator, OFDMDemodulator, RZFPrecoder, RemoveNulledSubcarriers
from sionna.phy.channel.tr38901 import AntennaArray, CDL
from sionna.phy.channel import subcarrier_frequencies, cir_to_ofdm_channel, cir_to_time_channel, time_lag_discrete_time_channel
from sionna.phy.channel import ApplyOFDMChannel, ApplyTimeChannel
...
class Model(Block):
    ...
    def __init__(self,
        ...
        if self._domain == "freq":  
            self._channel_freq = ApplyOFDMChannel()
