...
class UMa(SystemLevelChannel):
    r"""
    Urban macrocell (UMa) channel model from 3GPP
    ...
    :param o2i_model: Outdoor-to-indoor loss model for UTs located indoor.
        ...
        See section 7.4.3 of :cite:p:`TR38901V1920` for details.
    ...
    .. code-block:: python
        ...
        topology = gen_tr38901_multicell_topology("uma",
                                                  batch_size=1,
                                                  num_ut_per_sector=1,
                                                  carrier_frequency=carrier_frequency,
                                                  num_rings=1,
    ...
    def set_topology(
        ...
        UMa calibration-style multi-cell topologies can be generated with
