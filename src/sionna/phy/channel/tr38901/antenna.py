...
class PanelArray(Object):
    ...
    panel_vertical_spacing : `None` (default) | `float`
    ...
    panel_horizontal_spacing : `None` (default) | `float`
    ...
    element_vertical_spacing : `None` (default) | `float`
        Element vertical spacing [multiple of wavelength].
        Defaults to 0.5 if set to `None`.

    element_horizontal_spacing : `None` (default) | `float`
...
class AntennaArray(PanelArray):
    ...
    vertical_spacing : `None` (default) | `float`
        Element vertical spacing [multiple of wavelength].
        Defaults to 0.5 if set to `None`.

    horizontal_spacing : `None` (default) | `float`
        Element horizontal spacing [multiple of wavelength].
        Defaults to 0.5 if set to `None`.
