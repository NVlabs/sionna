...
class TDL(ChannelModel):
    ...
    num_sinusoids : `int`, (default 20)
        Number of sinusoids for the sum-of-sinusoids model. Defaults to 20.

    los_angle_of_arrival : `float`, (default pi/4)
    ...
    num_rx_ant : `int`, (default 1)
        Number of receive antennas

    num_tx_ant : `int`, (default 1)
        Number of transmit antennas

    spatial_corr_mat : `None` (default) | [num_rx_ant*num_tx_ant,num_rx_ant*num_tx_ant], `tf.complex`
    ...
    rx_corr_mat : `None` (default) | [num_rx_ant,num_rx_ant], `tf.complex`
    ...
    tx_corr_mat : `None` (default) | [num_tx_ant,num_tx_ant], `tf.complex`
