...
class PUSCHDMRSConfig(Config):
    ...
    def type_a_position(self):
        ...
        `int`, 2 (default) | 3 :  Position of first DMRS OFDM symbol
            ...
            :class:`~sionna.phy.nr.PUSCHConfig.mapping_type` of
    ...
    def dmrs_port_set(self):
        ...
        `list`, [] (default) | [0,...,11] : List of used DMRS antenna ports
            ...
            :class:`~sionna.phy.nr.PUSCHConfig.num_layers` is a property of the
    ...
    def n_id(self):
        ...
        2-tuple, `None` (default), [[0,...,65535], [0,...,65535]]: Scrambling
            ...
            the property :class:`~sionna.phy.nr.CarrierConfig.n_cell_id` of the
    ...
    def n_id(self, value):
        if value is None:
            ...
            for e in value:
                assert e in list(range(65536)), \
                       "Each element of n_id must be in [0, 65535]"
            self._n_id = value
