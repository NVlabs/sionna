...
"""PUSCH Channel Estimation for the NR (5G) module of Sionna PHY"""
...
class PUSCHLSChannelEstimator(LSChannelEstimator):
    ...
    The implementation is similar to that of :class:`~sionna.phy.ofdm.LSChannelEstimator`.
    However, it additional takes into account the separation of streams in the same CDM group
    as defined in :class:`~sionna.phy.nr.PUSCHDMRSConfig`. This is done through
    ...
    dmrs_length : `int`, 1 | 2
        Length of DMRS symbols. See :class:`~sionna.phy.nr.PUSCHDMRSConfig`.
    ...
    interpolator : `None` (default) | :class:`~sionna.phy.ofdm.BaseChannelInterpolator`
        Interpolator such as :class:`~sionna.phy.ofdm.LMMSEInterpolator`,
