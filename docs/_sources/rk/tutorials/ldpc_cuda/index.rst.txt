...
.. note::
   ...
   The source code of this tutorial can be found in `plugins/ldpc_cuda/src/runtime/ldpc_decoder.cu <https://github.com/NVlabs/sionna-rk/blob/main/plugins/ldpc_cuda/src/runtime/ldpc_decoder.cu>`_.
