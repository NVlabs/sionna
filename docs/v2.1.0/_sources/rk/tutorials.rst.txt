...
Moving up the stack, the :ref:`link_adaptation` tutorial shows how to modify and customize the link adaptation algorithms in the MAC layer, building on the plugin mechanism introduced in :ref:`data_acquisition`. The :ref:`ric_xapps` tutorial introduces the RAN Intelligent Controller (RIC) architecture and demonstrates how to develop xApps for intelligent network control and optimization. The :ref:`channel_emulation` tutorial shows how to emulate the channel using the Sionna ray tracer - in simulation as well as in real RF mode, which pairs naturally with the link adaptation tutorial for controlled evaluation.
...
The :ref:`ric_xapps` tutorial introduces the RAN Intelligent Controller (RIC) architecture and demonstrates how to develop xApps for intelligent network control and optimization. The :ref:`channel_emulation` tutorial shows how to emulate the channel using the Sionna ray tracer - in simulation as well as in real RF mode.
...
.. toctree::
   ...
   tutorials/link_adaptation/index.rst
