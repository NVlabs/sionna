...
This is a script intended to track changes in configuration files and build the initial patches. It is not required in regular use cases.
...
.. code-block:: bash
    ...
    ./get-config-changes.sh --rk-dir . --source ./config --dest ./patches/config
...
:doc:`generate-configs.sh <generate-configs>`, :doc:`quickstart-cn5g.sh <quickstart-cn5g>`, :doc:`start_system.sh <start-system>`
