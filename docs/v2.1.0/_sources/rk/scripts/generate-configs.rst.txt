...
.. option:: --init-nested-repos
    ...
    Create a nested git repository for each configuration subdirectory. This allows tracking individual changes based from the OAI repository. This is used internally and is not needed in common use cases.
...
:doc:`quickstart-cn5g.sh <quickstart-cn5g>`, :doc:`start_system.sh <start-system>`
